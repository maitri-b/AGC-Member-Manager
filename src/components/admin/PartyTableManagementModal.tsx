            ...
            <div className="flex items-start justify-between mb-3">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  {registration.specialRequests && registration.specialRequests.trim() && (
                    <div className="relative group">
                      ...
                      <div className="absolute left-0 top-6 z-50 hidden group-hover:block w-64 p-3 bg-gray-900 text-white text-xs rounded-lg shadow-lg">
                        <div className="font-semibold mb-1">ความต้องการพิเศษ:</div>
                        <div className="whitespace-pre-wrap">{registration.specialRequests}</div>
